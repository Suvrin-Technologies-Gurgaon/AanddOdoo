...
class HrPayslip(models.Model):
    ...
    input_line_ids = fields.One2many(
        "hr.payslip.input", "payslip_id", string="Payslip Inputs", readonly=True
    )
    ...
    credit_note = fields.Boolean(
        readonly=True, help="Indicates this payslip has a refund of another"
    )
...
class HrPayslipLine(models.Model):
    ...
    total = fields.Float(compute="_compute_total", digits="Payroll", store=True)
